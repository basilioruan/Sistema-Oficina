 ...
 * @author rmb
 */
public class TelaExibirTodas extends javax.swing.JFrame {

    /**
     * Creates new form TelaExibirTodas
     */
    public TelaExibirTodas() throws IOException, ClassNotFoundException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("SGO - Listar Todas Peças");
        setResizable(false);

        jLabel1.setText("Listar todas as peças");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExibirTodas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
